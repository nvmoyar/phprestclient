...
//comment the first and the third next lines if you want to retrieve the whole cfgsymbol elements
//$api_request_parameters = array('select'=>"Name,Enable,SecGroups");
$api_request_parameters = array('select'=>"Name,Enable");
$api_request_url = "http://$server1/MP.MetaTrader.WebApi//api/CfgGroup";
